angular
.module("mistApp")
.controller("snakeController", function ($scope) {
    ...
    snakeHeadImage.src = "./games/snake/resources/head.png";
    snakeBodyImage = new Image();
    snakeBodyImage.src = "./games/snake/resources/body.png";
    snakeTailImage = new Image();
    snakeTailImage.src = "./games/snake/resources/tail.png";

    //food
    foodImage = new Image();
    foodImage.src = "./games/snake/resources/food.png";
